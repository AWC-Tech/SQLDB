...
CREATE TABLE sprintcars3 (
  ...
  ```
This multi-lined code creates a table within the SQL Database. CREATE TABLE 'sprintcars3' defines that I want to create a table named 'sprintcars3'. <br>
'pos INT PRIMARY KEY' is the first column that is going to be created in the table. 'pos' is the name of the column, which in this case means position. <br>
